...
<%--&lt;%&ndash; ===== ORDER MODAL (Đã chỉnh sửa bố cục) ===== &ndash;%&gt;--%>
<%--<div class="modal fade" id="orderModal" tabindex="-1" aria-hidden="true">--%>
<%--    <div class="modal-dialog modal-dialog-centered modal-lg"> &lt;%&ndash; Thêm modal-lg để rộng hơn &ndash;%&gt;--%>
...
<%--                &lt;%&ndash; Trong modal-body của orderModal &ndash;%&gt;--%>
<%--                <div id="paymentSection"> &lt;%&ndash; Bọc lại để ẩn/hiện &ndash;%&gt;--%>
...
<%--                    </div>--%>
<%--                </div>--%>
<%--                &lt;%&ndash; Trong phần #paymentSection của orderModal &ndash;%&gt;--%>
